...
class ImageOptimizer {
    ...
    prepareAllImages() {
        ...
        const images = document.querySelectorAll('img[data-src], img[data-optimize="true"], img:not([data-optimized])');
    ...
    reportPerformanceMetrics() {
        ...
        const metrics = {
            ...this.performanceMetrics,
            loadSuccessRate: (this.performanceMetrics.loadedImages / this.performanceMetrics.totalImages) * 100,
            webpUsageRate: this.supportsWebP ?
                (this.performanceMetrics.webpSupported / this.performanceMetrics.loadedImages) * 100 : 0
        };
    ...
    getPerformanceReport() {
        ...
        return {
            ...
            webpUsageRate: this.supportsWebP && loaded > 0 ?
                ((this.performanceMetrics.webpSupported / loaded) * 100).toFixed(1) + '%' : '0%',
