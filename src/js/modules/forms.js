...
class FormsManager {
  ...
  showFormMessage(form, message, type) {
    ...
    const bgColor = type === 'success' ? '#d4edda' : type === 'warning' ? '#fff3cd' : '#f8d7da';
    const borderColor = type === 'success' ? '#c3e6cb' : type === 'warning' ? '#ffeaa7' : '#f5c6cb';
    const textColor = type === 'success' ? '#155724' : type === 'warning' ? '#856404' : '#721c24';
    const icon =
      type === 'success'
        ? 'check-circle'
        : type === 'warning'
