...
function createArtworkCard(artwork) {
    ...
    const imagePath = artwork.image.startsWith('../')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    showMessage('JavaScript file with embedded data exported successfully! You\'ll need to update your existing artwork-loader.js file with this new data.', 'success');
}
        ...
        reader.onload = function(e) {
            try {
                ...
                if (!newData.categories || !newData.artworks) {
                    throw new Error('Invalid data structure. JSON must contain categories and artworks arrays.');
                }
...
function renderCategories() {
    ...
    if (!artworkData.categories || artworkData.categories.length === 0) {
        container.innerHTML = '<p class="no-results">No categories found. Add your first category using the "Add Category" button above.</p>';
        return;
    }
    ...
    document.querySelectorAll('.delete-category').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (artworksUsingCategory.length > 0) {
                showMessage(`Cannot delete category "${category.name}" because it's used by ${artworksUsingCategory.length} artworks.`, 'error');
                return;
            }
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="category-${index}" class="batch-item-category">
                                    ${artworkData.categories.map(cat =>
